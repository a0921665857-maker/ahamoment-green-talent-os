...
export const judgment: JudgmentContent = {
  ...
  map: {
    ...
    overviewTitle: '全圖',
    overviewHint: '每個點是一項能力，線是「要先會」的關係，由上往下走。點任一個點，下面會畫出它的路線。',
    legendHub: '圈裡的數字＝有幾項以它為先修',
    legendTerminus: '實心小點＝沒有別的能力以它為先修',
    legendFinance: '方形＝財務側',
    isolatedNote: '虛線那一個跟其他 25 項沒有前後關係',
    startTitle: '不用先修，今天就能開始的 5 項',
    opensN: '這一項會打開後面 {n} 項',
    opensNone: '這一項獨立，不打開別的',
    routeTitle: '看路線',
    routeCount: '這條路線 {n} 站',
    roleUp: '要先會',
    roleFocus: '這一項',
