    ...
    blocks: [
      {
        ...
        body: '因為資訊早就免費了。真正貴的從來不是知識本身，是三件事：有人幫你決定該學哪些、有人在你想錯的時候告訴你錯在哪、以及有具體情境讓你練判斷。這裡只做這三件事。',
      },
      {
        heading: '判斷練習為什麼要先選才給看',
        body: '因為看著答案讀，你會覺得自己懂了，然後在真的要決定時發現不會。先押一個，你才會記得住為什麼錯。這也是為什麼每個錯誤選項都會告訴你它為什麼誘人：課堂討論最貴的部分不是聽到正確答案，是聽到你那個錯答案為什麼錯。',
      },
      {
        heading: '這一版是 Beta',
