...
export const questions: QuestionsContent = {
  ...
  emailGate: {
    // 報告交付框架；2026-06-15 經創辦人同意改為誠實版。
    // 2026-08-08 UX 審計：舊文案承諾「立即產出／即時顯示」，實際生成需要 3–5 分鐘，
    // 踩到 UX_PRINCIPLES 第 5 條誠實進度。改成誠實預告，不再承諾即時。
    title: '留個 email，報告寫好寄給你',
    body: '報告不是即時生成的，通常需要三到五分鐘寫完。寫好之後會寄到你的信箱，也會保存在這個連結，隨時可以回來看。',
    emailLabel: 'Email',
