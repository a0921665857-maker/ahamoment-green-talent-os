...
export const seo: SeoContent = {
  siteName: 'AhaMoment Green Career MRI',
  titles: {
    home: 'ESG career change, climate finance jobs & MBA positioning | Green Career MRI',
    mri: 'Start your free green career diagnostic | ESG, sustainability, climate',
