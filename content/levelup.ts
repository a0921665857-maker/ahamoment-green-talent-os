...
const zhTW: LevelupReport = {
  ...
  s1Intro:
    '同一份全球調查、同一個問法（「有這技能的人比沒有的多領多少」）。實心的金條，是查得到乾淨數字的；斜線的空條，是市場明說「更高」、卻沒有一份公開調查敢掛出一個數字的。空條代表這項技能還沒被標準化，跟它值不值錢是兩件事。',
  rungs: [
    {
      name: '碳核算 × Scope 3',
      val: '+12–18%',
  ...
  whyBody1:
    '市場明明在搶會做 LCA、會接 CSRD 的人，卻查不到一個乾淨的溢價數字。原因是這些技能太新、樣本太散，沒有一份公開調查敢替它掛上一個具體百分比。',
  whyBody2:
